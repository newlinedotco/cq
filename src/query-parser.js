module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c1 = function(term, modifiers) {
            if(modifiers) {
        ...
        peg$c8 = function(operator, number) {
            return {
        ...
        peg$c18 = { type: "other", description: "integer" },
        peg$c19 = /^[0-9]/,
        ...
        peg$c30 = "EOF",
        peg$c31 = { type: "literal", value: "EOF", description: "\"EOF\"" },
    ...
    function peg$parseSelectionExpression() {
      ...
      s0 = peg$currPos;
      s1 = peg$parseTermWithModifiers();
      if (s1 !== peg$FAILED) {
        s2 = [];
        s3 = peg$currPos;
        s4 = peg$parsews();
        if (s4 !== peg$FAILED) {
          s5 = peg$parseTermWithModifiers();
          if (s5 !== peg$FAILED) {
            s4 = [s4, s5];
            s3 = s4;
          } else {
    ...
    function peg$parseTermWithModifiers() {
      var s0, s1, s2, s3;
    ...
    function peg$parseModifier() {
      ...
      s0 = peg$currPos;
      s1 = peg$parseModifierOperator();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseLineNumber();
        if (s2 !== peg$FAILED) {
          peg$savedPos = s0;
          s1 = peg$c8(s1, s2);
          s0 = s1;
    ...
    function peg$parseModifierOperator() {
      var s0;
